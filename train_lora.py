...
dialogues = [
    ...
    {"input": "Any premium economy flights?", "output": "I can find flights from San Francisco to Chicago on next Monday in premium economy. Please provide additional details like airline."},
...
def main():
    # Initialize WandB
    wandb.init(project="atis_chatbot_lora", name="flan-t5-xl-lora-finetuning", config={
    ...
    try:
        ...
        class LossLoggingCallback(TrainerCallback):
            ...
            def on_train_end(self, args, state, control, **kwargs):
                ...
                plt.legend()
                plt.grid(True)
                plot_path = "./plots/lora_training_loss_plot.png"
        ...
        print(f"LoRA adapters saved to ./lora_adapters")
        ...
        print("Ensure SentencePiece is installed (`pip install sentencepiece`) and sufficient VRAM is available.")
